...
<!-- Bootstrap core CSS -->
    ...
    <script type="text/javascript">
	    ...
	    $(function(){
	    	...
	    	packetSendSpeed = $('#packet_send_speed_span').text();
    	...
    	var throughputList;
   	    ...
   	    function getThroughputList(page,pageSize){
   	    	 $.ajax( { 
   				    url:'getThroughputInfo.json',// 跳转到 controller 
   				    type:'post', 
   				    cache:false, 
   				    dataType:'json', 
   				    async: false,
    	...
    	function startThroughputTest(){
    		...
    		$.ajax( { 
			    url:'networkThroughput.json',// 跳转到 controller 
			    type:'post', 
			    cache:false, 
			    data:{ 
			    ...
			    async: false,
			    success:function(data) { 
			    	window.location.href="network_throughput.wsn?throughput=true&packetSendSpeed="+packetSendSpeed;
			    }, 
			    error : function() { 
			    	 $.alert({
	                      title: 'Oh no',
 ...
 <div class="jumbotron">
  ...
  <div class="container">
 	...
 	<legend>测试结果列表</legend>
	 	<span>发包速度(字节/秒):</span>&nbsp;&nbsp;&nbsp;<span id="packet_send_speed_span" class="bluea">${packetSendSpeed}</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
